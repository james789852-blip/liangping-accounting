...
export default function AddStoreForm() {
  ...
  function handleSubmit() {
    ...
    startTransition(async () => {
      const r = await createStore(name.trim(), mode)
  ...
  return (
    <div className="bg-white rounded-2xl p-5 space-y-4" style={{ border: '2px solid #c7d2fe', boxShadow: '0 2px 8px rgba(99,102,241,0.1)' }}>
      ...
      <button onClick={handleSubmit} disabled={pending || !name.trim()}
        ...
        style={{ background: 'linear-gradient(135deg,#6366f1,#8b5cf6)', opacity: pending || !name.trim() ? 0.6 : 1, boxShadow: '0 4px 12px rgba(99,102,241,0.3)' }}>
