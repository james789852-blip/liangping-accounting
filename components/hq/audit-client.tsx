...
const EVENT_LABELS: Record<string, string> = {
  ...
  ck_hq_paid: '央廚補款',
  sheets_sync_complete: '試算表同步完成',
  sheets_sync_failed: '試算表同步失敗',
  variance_alert: '誤差警報',
  ck_price_update: '央廚單價變更',
  ck_price_created: '新增央廚單價',
  ck_price_updated: '修改央廚單價',
  ck_price_override_update: '設定央廚單日特例',
  ck_price_override_delete: '取消央廚單日特例',
  store_update: '店家資料修改',
