...
test('手機版通知鈴鐺固定在頂端操作列最右側，不再浮在內容上', () => {
  ...
  assert.match(hqNavSource, /hq-mobile-actions[\s\S]*<NotificationCenter \/>/)
  assert.match(managerNavSource, /href=\{HR_SYSTEM_URL\}[\s\S]*<NotificationCenter \/>/)
